...
const RiskAssessment = ({ selectedDate = null }) => {
  ...
  if (!riskData || !riskData.risk_assessments || riskData.risk_assessments.length === 0) {
    return (
      <div className="w-full max-w-5xl p-4">
        <div className="bg-gray-50 rounded-lg p-6 text-center">
          <p className="text-gray-600">No risk assessment data available for {currentDate}</p>
          <button 
            onClick={fetchRiskAssessment}
  ...
  const highestRiskNEO = risk_assessments && risk_assessments.length > 0 ? risk_assessments[0] : null;
        ...
        <div className="px-6 py-4 border-b border-blue-200">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <h2 className="text-xl font-bold text-gray-900 mb-2 sm:mb-0">
              {currentDate === new Date().toISOString().split('T')[0] ? "Today's" : ""} Risk Assessment
            </h2>
        ...
        <div className="p-6 border-b border-blue-200">
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            <div className="bg-white p-4 rounded-lg shadow border border-blue-200 text-center">
              ...
              <p className="text-gray-900 text-2xl font-bold mt-2">{risk_summary.total_objects}</p>
            </div>
            <div className="bg-white p-4 rounded-lg shadow border border-blue-200 text-center">
              <h3 className="text-blue-500 text-sm font-medium">Critical</h3>
              <p className="text-gray-900 text-2xl font-bold mt-2">{risk_summary.critical_risk}</p>
            </div>
            <div className="bg-white p-4 rounded-lg shadow border border-blue-200 text-center">
              <h3 className="text-blue-500 text-sm font-medium">High</h3>
              <p className="text-gray-900 text-2xl font-bold mt-2">{risk_summary.high_risk}</p>
            </div>
            <div className="bg-white p-4 rounded-lg shadow border border-blue-200 text-center">
              <h3 className="text-blue-500 text-sm font-medium">Moderate</h3>
              <p className="text-gray-900 text-2xl font-bold mt-2">{risk_summary.moderate_risk}</p>
            </div>
            <div className="bg-white p-4 rounded-lg shadow border border-blue-200 text-center col-span-2 sm:col-span-1">
              ...
              <p className="text-gray-900 text-2xl font-bold mt-2">{risk_summary.low_risk + risk_summary.minimal_risk}</p>
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between">
              <div className="flex-1">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                  ...
                  <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${getRiskColorClass(highestRiskNEO.risk_level)}`}>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-sm text-blue-500">{highestRiskNEO.risk_description}</p>
                  </div>

                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="bg-white p-4 rounded-lg shadow border border-blue-200">
                      <h3 className="text-blue-500 text-sm font-medium">Risk Score</h3>
                      <p className="text-gray-900 text-xl font-bold mt-2">{highestRiskNEO.risk_score}/100</p>
                    </div>
                    <div className="bg-white p-4 rounded-lg shadow border border-blue-200">
                      <h3 className="text-blue-500 text-sm font-medium">Size</h3>
                      <p className="text-gray-900 text-xl font-bold mt-2">{highestRiskNEO.size_km.toFixed(3)} km</p>
                    </div>
                    <div className="bg-white p-4 rounded-lg shadow border border-blue-200">
                      <h3 className="text-blue-500 text-sm font-medium">Distance</h3>
                      <p className="text-gray-900 text-xl font-bold mt-2">{highestRiskNEO.miss_distance_lunar} LD</p>
                    </div>
                    <div className="bg-white p-4 rounded-lg shadow border border-blue-200">
                      <h3 className="text-blue-500 text-sm font-medium">Velocity</h3>
                      <p className="text-gray-900 text-xl font-bold mt-2">{(highestRiskNEO.velocity_kmh / 1000).toFixed(0)}k km/h</p>
                    </div>
                  </div>
